...
- **[engineering-review](./engineering-review/SKILL.md)**: Strict principal-engineer readiness review of a branch, PR, or plan: trace every change UI to DB and back, demand evidence per requirement (Pass / Risk / Missing evidence), challenge each design decision, enforce coding standards, and produce a defensible review report.
